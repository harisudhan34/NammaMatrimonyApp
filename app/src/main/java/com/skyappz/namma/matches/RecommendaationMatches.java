...
public class RecommendaationMatches extends Fragment implements WebServiceListener {
    ...
    public static RecommendaationMatches newInstance() {
        return new RecommendaationMatches();
    }

    public RecommendaationMatches() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_recommendaation_matches, container, false);
