...
public class EducationMatches extends Fragment implements WebServiceListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_education_matches, container, false);
    ...
    public void get_education_matches() {
        ...
        String url = URL_GET_TODAY_MATCHES+ AppController.get_userid(getActivity()) +"&type=education_matches&parameter=age,gender,height,weight,caste,marital_status,mother_tongue,raasi,having_dosham,physical_status,paadham,dosham_details" ;
        Log.e("url",url);
