...
public class PremiumMatches extends Fragment implements WebServiceListener {
    ...
    public static PremiumMatches newInstance() {
        return new PremiumMatches();
    }


    public PremiumMatches() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_premium_matches, container, false);
