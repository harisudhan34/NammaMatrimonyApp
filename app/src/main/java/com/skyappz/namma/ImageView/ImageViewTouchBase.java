...
import com.skyappz.namma.ImageView.easing.Cubic;
import com.skyappz.namma.ImageView.easing.Easing;
import com.skyappz.namma.ImageView.graphics.FastBitmapDrawable;
import com.skyappz.namma.ImageView.utils.IDisposable;
...
public abstract class ImageViewTouchBase extends ImageView implements IDisposable {
    ...
    public void setImageResource(int resId) {
        setImageDrawable(ContextCompat.getDrawable(getContext().getApplicationContext(), resId));
    }
    ...
    private void setImageBitmap(final Bitmap bitmap, Matrix matrix, float min_zoom, float max_zoom) {
        if (bitmap != null)
    ...
    private void onLayoutChanged(int left, int top, int right, int bottom) {
        if (LOG_ENABLED) {
    ...
    private void postScale(float scale, float centerX, float centerY) {
        ...
        Log.i("Image", "postScale: " + scale + ", center: " + centerX + "x" + centerY);
    ...
    void zoomTo(float scale, float durationMs) {
        PointF center = getCenter();
    ...
    void updateRect(RectF bitmapRect, RectF scrollRect) {
    ...
    void scrollBy(float distanceX, float distanceY, final double durationMs) {
