...
public class EditAbtMySelf extends Fragment implements WebServiceListener, View.OnClickListener {
    ...
    AppCompatEditText etAboutMyself;
    AppCompatTextView help;
    AppCompatButton update;
    String s_ed_abt;
    private static final String URL_GET_USER = "https://nammamatrimony.in/api/getuser.php?user_id=";
    public static EditAbtMySelf newInstance() {
        return new EditAbtMySelf();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        View view= inflater.inflate(R.layout.fragment_edit_about_myself, container, false);
        etAboutMyself = (AppCompatEditText)view.findViewById(R.id.etAboutMyself);
        help=(AppCompatTextView)view.findViewById(R.id.help) ;
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            if (response.getString("status").equalsIgnoreCase("true")){
                                ...
                                etAboutMyself.setText(user.getString("about_myself"));
    ...
    public void update() {
        ...
        dialog.show();
        s_ed_abt=etAboutMyself.getText().toString();
        if (Utils.isConnected(mActivity)) {
          if (s_ed_abt.equalsIgnoreCase("")){
              Utils.showToast(getActivity(),"Enter About My Self");
          }else {
              checkparams();
          }
            //signUp(user);
            ...
            switch (v.getId()) {
                case R.id.save_and_continue:
                    if (finalstring.equals("")){
                        ...
                        dialog.dismiss();
                        s_ed_abt=finalstring;
                        etAboutMyself.setText(finalstring);
